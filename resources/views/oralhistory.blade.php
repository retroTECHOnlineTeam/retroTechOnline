<div>  
  ...
  <div>
    <a href="{{ $history_data['history_url'] }}" target="_blank"><img srcset="{{ $data['history_img'] }}" sizes="(min-width:880px) 50vw, 100vw." src="{{ $data['history_img'] }}" typeof="foaf:Image" ></a>
  ...
  <div class="l-center l-content-container small paragraph paragraph--type--cta-links paragraph--view-mode--default">
    <section class="cta-links">
      <a href="{{ $history_data['history_url'] }}" target="_blank" class="chevron-link">View Oral History</a>
    </section>
  </div>
</div>